...
- There is a variety of applications powered by __GCOPTER__ or __MINCO__ will not be listed in this page, for example, [visibility-aware aerial tracking](https://www.youtube.com/watch?v=G5taHOpAZj8), [planning with nonlinear drag effects](https://www.youtube.com/watch?v=670QxGBnvyM), etc.

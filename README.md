...
- [VertexEnumeration3D](https://github.com/ZJU-FAST-Lab/VertexEnumeration3D): Highly Efficient Vertex Enumeration for 3D Convex Polytopes (A Robust and Fast Substitute to [cddlib](https://github.com/cddlib/cddlib) in 3D).

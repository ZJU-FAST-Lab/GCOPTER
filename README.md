...
__GCOPTER__ is an efficient and versatile multicopter trajectory optimizer built upon a novel sparse trajectory representation [__MINCO__](https://arxiv.org/pdf/2103.00190v2.pdf). __User-defined state-input constraints__ for multicopter dynamics involving __nonlinear drag effects__ are supported. For example, it handles avoidance of dynamic obstacles, restrictions on body rates, or even motor speeds.
